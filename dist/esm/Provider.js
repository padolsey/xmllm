...
import { estimateTokens, estimateMessageTokens, estimateMessagesTokens } from './utils/estimateTokens.mjs';
  ...
  return _createClass(Provider, [{
    ...
    value: function () {
      var _makeRequest = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(payload) {
        ...
        var limitCheck, trippedLimits, latestResetInMs, retries, maxRetries, lastError, result, delay;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              throw new ProviderError("Circuit breaker is open for provider ".concat(this.name), 'CIRCUIT_BREAKER_OPEN', this.name);
            case 4:
              ...
              trippedLimits = Object.entries(limitCheck.limits).filter(function (_ref) {
              ...
              latestResetInMs = trippedLimits.length ? Math.max.apply(Math, _toConsumableArray(trippedLimits.map(function (t) {
                return t.resetInMs;
              }))) : 0;
    ...
    value: function () {
      var _attemptRequest = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(payload) {
        var preparedPayload, controller, timeoutId, _data$content, _data$choices, response, data, result;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 15:
              data = _context2.sent;
              result = data !== null && data !== void 0 && (_data$content = data.content) !== null && _data$content !== void 0 && (_data$content = _data$content[0]) !== null && _data$content !== void 0 && _data$content.text ? {
                content: data.content[0].text
              } : data === null || data === void 0 || (_data$choices = data.choices) === null || _data$choices === void 0 || (_data$choices = _data$choices[0]) === null || _data$choices === void 0 ? void 0 : _data$choices.message; // BUG-14: don't silently return undefined for an unrecognized 200 shape.
              if (!(result == null)) {
                _context2.next = 19;
                break;
              }
              throw new ProviderError("Unrecognized response shape from ".concat(this.name), 'INVALID_RESPONSE', this.name);
            case 19:
    ...
    value: function () {
      var _handleErrorResponse = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(response) {
        ...
        var errorBody, errorJson, _errorJson$error, _errorJson$error2, errorType, errorMessage, authErrorKeywords, retryAfter, resetInMs;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              throw new ProviderNetworkError(this.name, undefined, 'No response received');
            case 3:
              _context3.next = 5;
            ...
            case 17:
              ...
              _context3.next = _context3.t0 === 429 ? 20 : _context3.t0 === 408 ? 25 : _context3.t0 === 504 ? 25 : 26;
              break;
            case 20:
              logger.log('Detected 429 rate limit response');
              retryAfter = response.headers.get('Retry-After');
              logger.log('Retry-After header:', retryAfter);
              resetInMs = this.parseRetryAfter(retryAfter);
              throw new ProviderRateLimitError(this.name, resetInMs, [{
                type: 'rpm',
                resetInMs: resetInMs
              }]);
            case 25:
    ...
    key: "parseRetryAfter",
    value: function parseRetryAfter(value) {
      if (value == null || value === '') {
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              ...
              // An rpm bucket may not exist (it is removed when the rpm limit is
              // Infinity/unset), so limitCheck.limits.rpm can be undefined.
              trippedLimits = Object.entries(limitCheck.limits).filter(function (_ref5) {
    ...
    value: function preparePayload(customPayload) {
      ...
      var _ValidationService$va = ValidationService.validateMessages(customPayload.messages),
      ...
      var isO1Model = /^(?:o1|o3|o4)/.test(model.name);
      ...
      var maxTokensParam = isO1Model ? 'max_completion_tokens' : 'max_tokens';
      var maxTokensValue = customPayload[maxTokensParam] || customPayload.max_tokens || customPayload.maxTokens || DEFAULT_RESPONSE_TOKEN_LENGTH;

      // Calculate system message and latest user message token counts
      var systemTokens = estimateTokens(system);
      var latestUserMessage = ((_messages = messages[messages.length - 1]) === null || _messages === void 0 ? void 0 : _messages.content) || '';
      var latestUserTokens = estimateTokens(latestUserMessage);
      ...
      if (isNaN(maxContextSize)) {
        throw new ModelValidationError('Invalid autoTruncateMessages value', {
      ...
      if (minRequiredTokens > maxContextSize) {
        throw new ModelValidationError('Context size too small for system message, latest user message, and response', {
          provider: this.name,
      ...
      var totalHistoricalTokens = estimateMessagesTokens(historicalMessages);
        ...
        while (attempts < MAX_ATTEMPTS) {
          ...
          try {
            for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
              ...
              var actualTokens = estimateTokens(truncatedContent);
