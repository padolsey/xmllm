...
function initializeCache() {
  return new LRUCache({
    ...
    maxSize: 5000000,
    // Maximum cache size (in arbitrary units, here bytes)
...
function _del() {
  _del = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(key) {
...
function _set() {
  _set = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(key, value) {
    var data;
