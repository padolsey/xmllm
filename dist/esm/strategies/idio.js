...
var defaultStrategy = {
  ...
  genSystemPrompt: function genSystemPrompt() {
    ...
    var _getConfig$idioSymbol = getConfig().idioSymbols,
...
var minimalStrategy = {
  ...
  genSystemPrompt: function genSystemPrompt() {
    var subSystemPrompt = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
    var _getConfig$idioSymbol2 = getConfig().idioSymbols,
...
var seedStrategy = {
  ...
  genSystemPrompt: function genSystemPrompt() {
    var subSystemPrompt = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
    var _getConfig$idioSymbol3 = getConfig().idioSymbols,
  ...
  genUserPrompt: function genUserPrompt(scaffold, originalPrompt) {
    var _getConfig$idioSymbol4 = getConfig().idioSymbols,
...
var structuredStrategy = {
  ...
  genSystemPrompt: function genSystemPrompt() {
    var subSystemPrompt = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
    var _getConfig$idioSymbol5 = getConfig().idioSymbols,
...
var assertiveStrategy = {
  ...
  genSystemPrompt: function genSystemPrompt() {
    var subSystemPrompt = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
    var _getConfig$idioSymbol6 = getConfig().idioSymbols,
...
var exampleDrivenStrategy = {
  ...
  genSystemPrompt: function genSystemPrompt() {
    var subSystemPrompt = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
    var _getConfig$idioSymbol7 = getConfig().idioSymbols,
