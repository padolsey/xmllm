...
function stream(promptOrConfig) {
  ...
  var providerManager = Object.keys(keys || {}).length > 0 ? new ProviderManager({
    keys: keys
  }) : undefined;
      ...
      var _llmStream = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(payload) {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 6:
              return _context.abrupt("return", Stream(payload, providerManager));
            case 7:
            case "end":
...
export { configure, pipeline, xmllm, stream, simple, getConfig, resetConfig, types, registerProvider };
