...
function waitMessageGenerator() {
  return _waitMessageGenerator.apply(this, arguments);
}
function _waitMessageGenerator() {
  _waitMessageGenerator = _wrapAsyncGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return "Apologies for the wait. Still waiting for the provider...";
        case 2:
        case "end":
...
function _APIStream() {
  _APIStream = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(payload) {
    var PQueue;
            ...
            return _regeneratorRuntime().wrap(function _callee4$(_context4) {
              while (1) switch (_context4.prev = _context4.next) {
                case 0:
                  ...
                  hash = createHash('md5').update(JSON.stringify(cacheKeyParams)).digest('hex'); // Only check cache if caching is explicitly enabled
                          ...
                          while (1) switch (_context3.prev = _context3.next) {
                            case 0:
                              ...
                              if (waitMessageString && waitMessageDelay) {
                                waitMessageTimer = setTimeout(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
