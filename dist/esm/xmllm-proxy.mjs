...
function validateProxyConfig(config) {
  ...
  var validKeys = new Set(['port', 'corsOrigins', 'maxRequestSize', 'timeout', 'debug', 'verbose', 'globalRateLimit', 'globalTokensPerMinute', 'globalTokensPerHour', 'globalRequestsPerHour', 'rateLimitMessage', 'listen']);
...
function createServer() {
  ...
  var rateLimitMessage = config.rateLimitMessage || 'Please try again later';
  app.post('/api/stream', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
      var _req$body, messages, _req$body$model, model, max_tokens, maxTokens, temperature, top_p, topP, presence_penalty, presencePenalty, fakeDelay, stop, cache, stream, tokenEstimate, limitCheck, theStream, errorResponse;
