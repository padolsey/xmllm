        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 2:
              ...
              break;
            case 6:
              return _context3.abrupt("return", new ProviderAuthenticationError(this.name, errorBody));
            case 7:
              return _context3.abrupt("return", new ProviderRateLimitError(this.name, response.headers.get('Retry-After')));
            case 8:
              return _context3.abrupt("return", new ProviderTimeoutError(this.name, this.REQUEST_TIMEOUT_MS));
            case 9:
              return _context3.abrupt("return", new ProviderNetworkError(this.name, response.status, errorBody));
            case 10:
            case "end":
