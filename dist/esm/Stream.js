...
export function deriveCacheKey(payload) {
  var _ref, _payload$max_tokens, _payload$max_completi, _ref2, _payload$stop;
  var cacheKeyParams = _objectSpread({
    _v: CACHE_VERSION,
    ...
    max_tokens: (_ref = (_payload$max_tokens = payload.max_tokens) !== null && _payload$max_tokens !== void 0 ? _payload$max_tokens : payload.maxTokens) !== null && _ref !== void 0 ? _ref : null,
    // o-series models use max_completion_tokens as the response-length knob.
    max_completion_tokens: (_payload$max_completi = payload.max_completion_tokens) !== null && _payload$max_completi !== void 0 ? _payload$max_completi : null,
    stop: (_ref2 = (_payload$stop = payload.stop) !== null && _payload$stop !== void 0 ? _payload$stop : payload.stop_sequences) !== null && _ref2 !== void 0 ? _ref2 : null
  }, payload.system && {
...
function _APIStream() {
  _APIStream = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(payload, injectedProviderManager) {
    var PQueue, providerManager, validConcurrency;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 2:
          ...
          providerManager = injectedProviderManager || new ProviderManager(); // BUG-12: the queue is a shared module singleton. Honor forcedConcurrency on
          ...
          validConcurrency = Number.isInteger(payload.forcedConcurrency) && payload.forcedConcurrency > 0 ? payload.forcedConcurrency : undefined;
          if (!queue) {
            queue = new PQueue({
              concurrency: validConcurrency || DEFAULT_CONCURRENCY
            });
            ...
            return _regeneratorRuntime().wrap(function _callee3$(_context3) {
              while (1) switch (_context3.prev = _context3.next) {
                case 0:
                  ...
                  cache = payload.cache, cacheRead = payload.cacheRead, cacheWrite = payload.cacheWrite; // Normalize cache settings
                  shouldReadCache = cache === true ? true : _typeof(cache) === 'object' ? cache.read : cacheRead;
                  shouldWriteCache = cache === true ? true : _typeof(cache) === 'object' ? cache.write : cacheWrite;
                  hash = deriveCacheKey(payload); // Only check cache if cache reading is enabled
                  if (!shouldReadCache) {
                    _context3.next = 16;
                    break;
                  }
                        ...
                        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                          while (1) switch (_context2.prev = _context2.next) {
                            ...
                            case 35:
                              ...
                              if (!waitMessageSent) {
                                config = getConfig();
                                if (_context2.t0 instanceof ProviderRateLimitError) {
                                ...
                                } else if (_context2.t0 instanceof ProviderAuthenticationError) {
                                ...
                                } else if (_context2.t0 instanceof ProviderNetworkError) {
                                ...
                                } else if (_context2.t0 instanceof ProviderTimeoutError) {
...
export function _getConcurrency() {
  var _queue;
  return (_queue = queue) === null || _queue === void 0 ? void 0 : _queue.concurrency;
}