      ...
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 2:
          ...
          return _context4.abrupt("return", queue.add(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
            var encoder, content, cache, cacheRead, cacheWrite, shouldReadCache, shouldWriteCache, cacheKeyParams, hash, cachedData, ongoingRequest, ongoingRequestStream, _ongoingRequestStream, _ongoingRequestStream2, stream1, stream2, waitMessageString, waitMessageDelay, retryMax, retryStartDelay, retryBackoffMultiplier;
            return _regeneratorRuntime().wrap(function _callee3$(_context3) {
              while (1) switch (_context3.prev = _context3.next) {
                case 0:
                  ...
                  shouldWriteCache = cache === true ? true : _typeof(cache) === 'object' ? cache.write : cacheWrite; // Extract relevant parameters for cache key
                  ...
                  hash = createHash('md5').update(JSON.stringify(cacheKeyParams)).digest('hex'); // Only check cache if cache reading is enabled
                  if (!shouldReadCache) {
                    _context3.next = 17;
                    break;
                  }
