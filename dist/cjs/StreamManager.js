...
var logger = new _Logger["default"]('StreamManager');
var StreamManager = /*#__PURE__*/function () {
  ...
  return _createClass(StreamManager, [{
    key: "createStream",
    value: function () {
      var _createStream = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(stream, res) {
        var _this = this;
        var timeoutId, reader, _yield$reader$read, done, value, content;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              timeoutId = setTimeout(function () {
                _this.handleTimeout(res);
              }, this.timeout);
            ...
            case 17:
              ...
              logger.error('Stream error:', _context.t0);
              this.handleError(res, _context.t0);
            case 21:
              _context.prev = 21;
        ...
        }, _callee, this, [[3, 17, 21, 25]]);
      }));
      function createStream(_x, _x2) {
    ...
    key: "handleTimeout",
    value: function handleTimeout(res) {
    ...
    key: "cleanup",
    value: function cleanup(reader, res) {
      try {
        reader.releaseLock();
      ...
      var _closeAll = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              closePromises = Array.from(this.activeStreams).map(/*#__PURE__*/function () {
                var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(reader) {
...
var _default = exports["default"] = StreamManager;