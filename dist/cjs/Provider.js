          ...
          while (1) switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              limitCheck = this.resourceLimiter.consume(_objectSpread({
                ...
                tpm: (0, _estimateTokens.estimateMessagesTokens)(payload.messages)
              } : {}));
              ...
              throw new _ProviderErrors.ProviderRateLimitError(this.name, latestResetInMs, trippedLimits);
            case 11:
              retries = 0;
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 15:
              ...
              throw new _ProviderErrors.ProviderError("Unrecognized response shape from ".concat(this.name), 'INVALID_RESPONSE', this.name);
            case 19:
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 20:
              ...
              throw new _ProviderErrors.ProviderRateLimitError(this.name, resetInMs, [{
                type: 'rpm',
                resetInMs: resetInMs
              }]);
            case 25:
