...
var _excluded = ["prompt", "schema", "messages", "system", "mode", "onChunk", "strategy"];
...
function _simple() {
  _simple = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(promptOrConfig) {
    var options,
      config,
      globalConfig,
      aggConfig,
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return _context.abrupt("return", stream(promptOrConfig, options).last());
        case 6:
        case "end":
