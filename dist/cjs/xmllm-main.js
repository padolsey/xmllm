...
var _excluded = ["prompt", "schema", "system", "mode", "onChunk"],
  _excluded2 = ["mode"];
...
function stream(promptOrConfig) {
  ...
  var _config = config,
    ...
    mode = _config$mode === void 0 ? 'state' : _config$mode,
  ...
  if (schema) {
    return new _XMLStream["default"]([['req', _objectSpread(_objectSpread({
      ...
      llmStream: restOptions.llmStream || _Stream["default"]
    });
  }

  // Basic prompt without schema
  return new _XMLStream["default"]([['req', prompt]], _objectSpread(_objectSpread({}, restOptions), modeParams));
}

// Simple function also gets mode support
function simple(_x, _x2) {
  return _simple.apply(this, arguments);
}
function _simple() {
  _simple = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(prompt, schema) {
    var options,
      _options$mode,
      mode,
      restOptions,
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _options$mode = options.mode, mode = _options$mode === void 0 ? 'delta' : _options$mode, restOptions = _objectWithoutProperties(options, _excluded2);
          _context.next = 4;
