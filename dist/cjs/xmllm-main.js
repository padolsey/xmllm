...
Object.defineProperty(exports, "registerProvider", {
  enumerable: true,
  get: function get() {
    return _PROVIDERS.registerProvider;
  }
});
...
var _excluded = ["prompt", "schema", "messages", "system", "mode", "onChunk", "strategy", "keys"];
...
var pipeline = exports.pipeline = xmllm;
...
function stream(promptOrConfig) {
  ...
  if (typeof promptOrConfig === 'string') {
    _ValidationService["default"].validateLLMPayload(options);
    config = _objectSpread(_objectSpread(_objectSpread({}, globalConfig.defaults), {}, {
      prompt: promptOrConfig
    }, options), {}, {
      keys: _objectSpread(_objectSpread({}, globalConfig.defaults.keys || {}), options.keys || {})
    });
  } else {
    var aggConfig = _objectSpread(_objectSpread({}, promptOrConfig), options);
    _ValidationService["default"].validateLLMPayload(aggConfig);
    config = _objectSpread(_objectSpread(_objectSpread({}, globalConfig.defaults), aggConfig), {}, {
      keys: _objectSpread(_objectSpread({}, globalConfig.defaults.keys || {}), aggConfig.keys || {})
    });
  }
  var _config = config,
  ...
  var providerManager = Object.keys(keys || {}).length > 0 ? new _ProviderManager["default"]({
    keys: keys
  }) : undefined;
  ...
  return new _ChainableStreamInterface["default"]([['req', _objectSpread(_objectSpread({
    ...
    strategy: strategy,
    keys: keys
  }, modeParams), restOptions)]], {
    llmStream: function () {
      var _llmStream = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(payload) {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              return _context.abrupt("return", restOptions.llmStream(payload, providerManager));
            case 5:
              return _context.abrupt("return", restOptions.llmStream(payload));
            case 6:
              return _context.abrupt("return", (0, _Stream["default"])(payload, providerManager));
            case 7:
            case "end":
      ...
      function llmStream(_x) {
        return _llmStream.apply(this, arguments);
      }
      return llmStream;
    }()
  });
...
pipeline.registerProvider = _PROVIDERS.registerProvider;
