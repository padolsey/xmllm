...
function validateProxyConfig(config) {
  ...
  var validKeys = new Set(['port', 'corsOrigins', 'maxRequestSize', 'timeout', 'debug', 'verbose', 'globalRequestsPerMinute', 'globalTokensPerMinute', 'globalTokensPerHour', 'globalRequestsPerHour', 'rateLimitMessage', 'listen', 'errorMessages', 'paths']);
...
var ProxyBase = exports.ProxyBase = /*#__PURE__*/function () {
  function ProxyBase() {
    ...
    this.streamManager = new _StreamManager["default"](this.config);
    this.maxRequestSize = this.config.maxRequestSize || 1048576;
    this.timeout = this.config.timeout || 30000;
    this.globalLimiter = new _ResourceLimiter["default"]({
