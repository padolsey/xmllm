...
var ChainableStreamInterface = exports.ChainableStreamInterface = /*#__PURE__*/function () {
  function ChainableStreamInterface() {
    ...
    _classCallCheck(this, ChainableStreamInterface);
  ...
  return _createClass(ChainableStreamInterface, [{
    ...
    value: function select(selector) {
      return new ChainableStreamInterface([].concat(_toConsumableArray(this.pipeline), [['select', selector]]), this.options);
    }
    ...
    value: function accrue() {
      return new ChainableStreamInterface([].concat(_toConsumableArray(this.pipeline), [['accrue'],
    ...
    value: function map(fn) {
      return new ChainableStreamInterface([].concat(_toConsumableArray(this.pipeline), [['map', fn]]), this.options);
    }
  }, {
    key: "text",
    value: function text() {
    ...
    value: function take(n) {
      return new ChainableStreamInterface([].concat(_toConsumableArray(this.pipeline), [['take', n]]), this.options);
    }
  }, {
    key: "skip",
    value: function skip(n) {
      return new ChainableStreamInterface([].concat(_toConsumableArray(this.pipeline), [['skip', n]]), this.options);
    }
  }, {
    key: "filter",
    value: function filter(predicate) {
      return new ChainableStreamInterface([].concat(_toConsumableArray(this.pipeline), [['filter', predicate]]), this.options);
    }
  }, {
    key: "mergeAggregate",
    value: function mergeAggregate() {
      return new ChainableStreamInterface([].concat(_toConsumableArray(this.pipeline), [['mergeAggregate']]), this.options);
    }
  }, {
    key: "reduce",
    value: function reduce(reducer, initialValue) {
      return new ChainableStreamInterface([].concat(_toConsumableArray(this.pipeline), [['reduce', {
        reducer: reducer,
    ...
    value: function pipe(genFn) {
      return new ChainableStreamInterface([].concat(_toConsumableArray(this.pipeline), [['pipe', genFn]]), this.options);
    }
  }, {
    key: "raw",
    value: function raw() {
      return new ChainableStreamInterface([].concat(_toConsumableArray(this.pipeline), [['raw']]), this.options);
    }
  }, {
    key: "debug",
    value: function debug() {
      ...
      return new ChainableStreamInterface([].concat(_toConsumableArray(this.pipeline), [['map', function (value) {
            ...
            return _regeneratorRuntime().wrap(function _callee4$(_context4) {
              while (1) switch (_context4.prev = _context4.next) {
                ...
                case 5:
                  ...
                  iterator = null;
                  logger.error('ChainableStreamInterface error', _context4.t0);
                  throw _context4.t0;
                case 10:
                case "end":
    ...
    value: function batch(size) {
      ...
      return new ChainableStreamInterface([].concat(_toConsumableArray(this.pipeline), [['batch', size, options] // Pass both size and options to existing batch operator
      ]), this.options);
    }
  }]);
}();
var _default = exports["default"] = ChainableStreamInterface;
