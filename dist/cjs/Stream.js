...
exports._getConcurrency = _getConcurrency;
exports._resetStreamState = _resetStreamState;
 ...
 */
function deriveCacheKey(payload) {
  ...
  return (0, _crypto.createHash)('md5').update(JSON.stringify(cacheKeyParams)).digest('hex');
}
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 2:
          ...
          providerManager = injectedProviderManager || new _ProviderManager["default"](); // BUG-12: the queue is a shared module singleton. Honor forcedConcurrency on
