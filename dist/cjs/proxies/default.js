...
var DefaultProxy = /*#__PURE__*/function (_ProxyBase) {
  function DefaultProxy() {
    _classCallCheck(this, DefaultProxy);
    return _callSuper(this, DefaultProxy, arguments);
  }
  _inherits(DefaultProxy, _ProxyBase);
  return _createClass(DefaultProxy, [{
    key: "handleStreaming",
    value: function () {
      var _handleStreaming = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, res) {
        var messages, model, max_tokens, maxTokens, temperature, top_p, topP, presence_penalty, presencePenalty, errorMessages, fakeDelay, stop, cache, stream, theStream;
          ...
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              return (0, _Stream["default"])({
                ...
                errorMessages: _objectSpread(_objectSpread({}, this.config.errorMessages || {}), errorMessages || {}),
                stop: stop,
                fakeDelay: fakeDelay,
                model: model,
                cache: cache,
