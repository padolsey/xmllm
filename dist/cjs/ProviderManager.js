...
var ProviderManager = /*#__PURE__*/function () {
  function ProviderManager() {
    ...
    this.providers = {};
    for (var _i = 0, _Object$entries = Object.entries(_PROVIDERS["default"]); _i < _Object$entries.length; _i++) {
      var _Object$entries$_i = _slicedToArray(_Object$entries[_i], 2),
        name = _Object$entries$_i[0],
        details = _Object$entries$_i[1];
      this.providers[name] = new _Provider["default"](name, details);
    }
  }
  return _createClass(ProviderManager, [{
    key: "getProviderByPreference",
    value: function getProviderByPreference(preference, payloadModel) {
    ...
    value: function pickProvider() {
      ...
      var preferredProviders = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
      var payloadModel = arguments.length > 2 ? arguments[2] : undefined;
      if (preferredProviders.length > 0) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            try {
              var _this$getProviderByPr = this.getProviderByPreference(preference, payloadModel),
      ...
      var _request = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(payload) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              preferredProviders = _args.length > 1 && _args[1] !== undefined ? _args[1] : [];
              lastError = null;
              providersTried = [];
            ...
            case 4:
              ...
              provider = this.pickProvider(providersTried, preferredProviders);
              if (provider) {
                _context.next = 8;
                break;
              }
            ...
            case 8:
              ...
              _context.prev = 10;
              _context.next = 13;
              return provider.makeRequest(payload);
            case 13:
      ...
      var _streamRequest = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(payload) {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              preferredProviders = _args2.length > 1 && _args2[1] !== undefined ? _args2[1] : [];
              lastError = null;
              providersTried = [];
              totalProviders = preferredProviders.length;
            case 4:
              ...
              _this$pickProvider = this.pickProvider(providersTried, preferredProviders, payload.model), provider = _this$pickProvider.provider, modelType = _this$pickProvider.modelType;
              if (provider) {
                _context2.next = 8;
                break;
              }
