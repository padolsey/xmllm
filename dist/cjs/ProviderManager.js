...
var ProviderManager = /*#__PURE__*/function () {
  function ProviderManager() {
    ...
    this.providers = Object.entries(_PROVIDERS["default"]).map(function (_ref) {
      var _ref2 = _slicedToArray(_ref, 2),
        name = _ref2[0],
        details = _ref2[1];
      return new _Provider["default"](name, details);
    });
  }
  ...
  return _createClass(ProviderManager, [{
    ...
    value: function pickProvider() {
      ...
      var availableProviders = this.providers.filter(function (provider) {
        return provider.getAvailable() && !excludeProviders.includes(provider);
      });
    ...
    value: function () {
      var _request = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(payload) {
        var lastError, providersTried, provider;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              providersTried = [];
            case 2:
              if (!(providersTried.length < this.providers.length)) {
                _context.next = 20;
                break;
              }
              provider = this.pickProvider(providersTried);
              if (provider) {
                _context.next = 6;
                break;
              }
            ...
            case 14:
              ...
              lastError = "".concat(provider.name, " failed, trying next one");
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 14:
              ...
              if (_context2.t0.message.includes('401')) {
                _context2.next = 19;
                break;
              }
              throw _context2.t0;
            case 19:
              lastError = "Authorization failed for ".concat(provider.name, ", trying next provider.");
            case 20:
              _context2.next = 2;
              break;
            case 22:
