...
var ProviderManager = /*#__PURE__*/function () {
  ...
  return _createClass(ProviderManager, [{
              ...
              _loop = /*#__PURE__*/_regeneratorRuntime().mark(function _loop() {
                ...
                return _regeneratorRuntime().wrap(function _loop$(_context) {
                  while (1) switch (_context.prev = _context.next) {
                    case 0:
                      _context.prev = 0;
                      logger.log("Attempt ".concat(retry + 1, " for ").concat(provider.name)); // Debug
                      _context.next = 4;
                    ...
                    case 9:
                      ...
                      logger.error("Error from provider ".concat(provider.name, " (attempt ").concat(retry + 1, "):"), _context.t0);
                      ...
                      if (!(_context.t0 instanceof _ProviderErrors.ProviderAuthenticationError)) {
                        _context.next = 17;
                        break;
                      }
                    ...
                    case 17:
                      ...
                      isTransient = provider.shouldRetry(_context.t0) || _context.t0 instanceof _ProviderErrors.ProviderTimeoutError;
                      if (isTransient) {
                        _context.next = 21;
                        break;
                      }
    ...
    value: function createCustomProvider(customConfig) {
      ...
      var customProvider = new _Provider["default"]("".concat(inherit, "_custom"), (0, _PROVIDERS.createCustomModel)(baseProvider, {
        name: name,
        endpoint: endpoint,
        key: key,
