...
var CACHE_DIR = _path["default"].join(process.cwd(), '.cache');
var CACHE_FILENAME = 'llm-cache.json';
var CACHE_FILE = _path["default"].join(CACHE_DIR, CACHE_FILENAME);
...
function updateCachePath(dir, filename) {
  ...
  CACHE_FILE = _path["default"].join(CACHE_DIR, CACHE_FILENAME);
}
  ...
  _ensureCacheDir = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          return _context6.abrupt("return", fileOps.ensureDir(_path["default"].dirname(CACHE_FILE)));
        case 1:
        case "end":
