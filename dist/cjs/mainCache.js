...
exports._setModified = _setModified;
exports.checkMemoryPressure = checkMemoryPressure;
exports.cleanup = cleanup;
exports.clearExpired = clearExpired;
exports.configure = configure;
exports.defaultFileOps = void 0;
exports.del = del;
...
var defaultFileOps = exports.defaultFileOps = {
  promises: {
    mkdir: function () {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return _fs.promises.mkdir(dirPath, options);
            case 3:
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              _context2.next = 3;
              return _fs.promises.writeFile(filePath, data);
            case 3:
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _context4.prev = 0;
              _context4.next = 3;
              return _fs.promises.rename(oldPath, newPath);
            case 3:
...
function setFileOps(mockFileOps) {
  fileOps = mockFileOps;
...
var fileOperations = exports.fileOperations = {
      ...
      while (1) switch (_context9.prev = _context9.next) {
        case 0:
          if (cache) {
            ...
            newCache = new _lruCache.LRUCache({
    ...
    return _regeneratorRuntime().wrap(function _callee14$(_context14) {
      while (1) switch (_context14.prev = _context14.next) {
        ...
        case 9:
          ...
          cache = new _lruCache.LRUCache(_objectSpread({}, cacheOptions));
